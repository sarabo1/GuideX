...
//     );
//     console.log('allTheFavorite:', this.allTheFavorite);
...
//   setData() {
//     for (const item of this.allTheFavorite) {
//       this.isLiked.push(true);

//       if (item.attractionsId !== undefined) {
//         this.numberId.push(item.attractionsId);
//         this.typeName.push('attraction');
//       } else if (item.HostelsId !== undefined) {
//         this.numberId.push(item.HostelsId);
//         this.typeName.push('hostel');
//       } else if (item.WalkingTrailId !== undefined) {
